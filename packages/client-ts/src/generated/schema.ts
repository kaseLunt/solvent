...
export interface paths {
    ...
    "/v1/scenarios": {
        ...
        /**
         * The committed scenario set — the definitions themselves, servable cold
    ...
    "/v1/scenarios/run-book-set": {
        ...
        put?: never;
        /**
         * N committed scenarios evaluated against ONE resolved batch
...
export interface components {
    schemas: {
        ...
        /**
         * @description One COMMITTED scenario's DEFINITION: what it shocks, on which primitive
        ...
        ScenarioDefinition: {
            ...
            /**
             * @description The engines this scenario is DEFINED for. An engine absent here is
        ...
        /**
         * @description One committed scenario AT AN ADDRESS: the `ScenarioDefinition` fields —
        ...
        /**
         * @description The committed scenario listing. NO batch envelope, deliberately: the set
        ...
        ScenariosResponse: {
            ...
            served_at: string;
            /**
             * @description The committed set's version AS A WHOLE — the same token `/v1/meta`,
             ...
             */
            scenario_config_version: string;
            scenarios: components["schemas"]["ScenarioDefinition"][];
            notes: string[];
        };
        ObservatoryPoint: {
            /** Format: int64 */
        ...
        Constants: {
            ...
            set_run_token_cost_per_scenario: number;
        ...
        PositionsResponse: {
            ...
            engine: string;
            /**
             * @description The ranking actually applied, echoed so a defaulted request still
             ...
             * @enum {string}
             */
            sort: "headroom" | "liq_distance" | "debt" | "hf" | "status";
        ...
        LiqDistance: {
            ...
            /**
             * @description The `factor_asset`'s ticker, from the service's own valuation
        ...
        /**
         * @description The ids to evaluate against ONE resolved batch. THERE IS NO IMPLICIT
        ...
        /**
         * @description ONE mark this scenario's propagation matrix never described, by the
        ...
        /**
         * @description WHAT ARRIVED, beside the `shocks` array's WHAT WAS REQUESTED. On this
        ...
        SetRunShockReach: {
            ...
            /**
             * @description Derived by a switch in a FIXED ORDER with no default arm, so it is
             ...
             * @enum {string}
             */
            reach: "projection_no_spot_pass" | "no_shocks_declared" | "all_shocks_declared_at_identity" | "no_shock_reached_the_book" | "no_mark_moved" | "some_marks_held" | "every_mark_moved";
            /**
             * @description The existing sealed component, verbatim, over THIS scenario's own
            ...
            applied_shocks: components["schemas"]["AppliedShock"][];
            /**
             * @description Applied rows whose `before` and `after` decimal strings DIFFER. THE
            ...
            marks_moved: number;
            /**
             * @description Held rows whose applied `factor_num == factor_den`: the MODEL asked
            ...
            /**
             * @description The distinct `(chain_id, asset)` identities behind those marks,
             ...
             */
            held_flat_assets: components["schemas"]["SetRunHeldFlatAsset"][];
            /** @description The arm's own sentence. No arm's sentence is ever served under another arm. */
            note: string;
        };
        /**
         * @description ONE (scenario, engine) reduced to a summary. It is deliberately NOT "the
        ...
        SetRunEngineSummary: {
            ...
            usd_decimals: number;
            /**
             * @description The discriminator for the two movement counts, served as an ENUM so a
             ...
             * @enum {string}
             */
            movement_rule: "hf_strictly_dropped" | "eligibility_flipped_false_to_true";
            ...
            /**
             * @description Of those, accounts the movement rule could not TEST for movement at
            ...
            /**
             * @description Covered-engine positions the BATCH refused. It equals this engine's
            ...
            before_eligible_debt_usd: components["schemas"]["Decimal"];
            ...
            eligible_debt_delta_usd: components["schemas"]["Decimal"];
            before_bad_debt_usd: components["schemas"]["Decimal"];
            ...
            bad_debt_delta_usd: components["schemas"]["Decimal"];
            before_collateral_at_risk_usd: components["schemas"]["Decimal"];
            ...
            after_collateral_at_risk_usd: components["schemas"]["Decimal"];
            ...
            total_debt_usd_before: components["schemas"]["Decimal"];
            ...
            total_debt_usd_after: components["schemas"]["Decimal"];
            total_collateral_usd_before: components["schemas"]["Decimal"];
            total_collateral_usd_after: components["schemas"]["Decimal"];
        ...
        /**
         * @description A covered, NON-withheld engine carrying nothing measurable.
         *
        ...
        SetRunEngineAbsence: {
            engine: string;
            /** @enum {string} */
            reason: "no_positions_in_batch" | "all_positions_refused_in_batch" | "all_positions_unrebuildable" | "mixed_no_measurable_positions";
            /** @description The counts BEHIND the reason, so the reason is checkable rather than a label. */
            counts: {
                positions_in_batch: number;
                refused_in_batch: number;
        ...
        /**
         * @description ONE scenario's answer at the shared batch.
         *
        ...
        SetRunScenarioResult: {
            ...
            shock_reach: components["schemas"]["SetRunShockReach"];
            ...
            withheld_engines: string[];
            unmeasurable_engines: components["schemas"]["SetRunEngineAbsence"][];
            ...
            engines: components["schemas"]["SetRunEngineSummary"][];
            /** @description Σ `engines[].accounts` — the positions that produced the numbers in this result. */
            positions_answered: number;
            /**
             * @description Reconstructable positions on covered-but-WITHHELD engines. They are
        ...
        /**
         * @description A census of the BATCH, not of any one run — which is why it is a new
        ...
        SetRunCoverage: {
            ...
            excluded: components["schemas"]["Excluded"][];
            /**
             * @description False when `in_book == 0`, or any position is excluded, or any engine
            ...
            engines: components["schemas"]["SetRunEngineCensus"][];
            note: string;
        };
        /**
         * @description THE FRESHNESS DISCLOSURE, about the instant this response was COMPOSED —
        ...
        SetRunEvaluation: {
            ...
            /**
             * @description FOUR ARMS, because the derivation compares two ORDERED ids and an id
             ...
             * @enum {string}
             */
            freshness: "still_newest" | "superseded" | "newest_is_older" | "none_servable";
            /**
             * Format: int64
             ...
             */
            newest_servable_batch_id: number | null;
            /** @description The arm's own sentence. The `newest_is_older` sentence never claims a materialization. */
            note: string;
        };
        RunBookSetResponse: {
            /** Format: date-time */
            ...
            batch: components["schemas"]["Batch"];
            evaluation: components["schemas"]["SetRunEvaluation"];
            ...
            results: components["schemas"]["SetRunScenarioResult"][];
            ...
            excluded_engines: components["schemas"]["EngineRefusal"][];
            coverage: components["schemas"]["SetRunCoverage"];
        ...
        /**
         * @description The 503 body for a set-run refused because the in-flight bound is full.
    ...
    runBookSet: {
        ...
        requestBody: {
            content: {
                 ...
                 *     }
                 */
                "application/json": components["schemas"]["SetRunRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["RunBookSetResponse"];
                };
            };
            /**
            ...
            503: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["SetRunBusyBody"] | components["schemas"]["ErrorBody"];
                };
            };
        };
    };
