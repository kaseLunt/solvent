// Wave R1 (web fix train)-scoped Playwright config: identical projects to
// ../playwright.config.ts, but on its OWN port (3814) with
// reuseExistingServer OFF — the w2/w4/w5/w6/wuxb/wuxc/wuxd wave convention:
//
//   npm run build && npx playwright test -c tests/playwright.r1.config.ts
//
