...
import { LEGACY_RESULT_FOOTNOTE, legacyResultSummary, tileAbsence, type BookWorkspace, type EngineReading } from "@/lib/lab-view";
...
export function LegacyResult({ reading, book }: { reading: EngineReading; book: Pick<BookWorkspace, "state" | "headline"> }) {
  return (
    <LegacyFold title={LEGACY_FOLD_TITLE} summary={legacyResultSummary(reading)} testId="lab-legacy">
